app/static/js/components/tagList.js
===================================
...
This UI component script powers tagList behavior on the client side. It coordinates DOM events and browser-side state for this area.
